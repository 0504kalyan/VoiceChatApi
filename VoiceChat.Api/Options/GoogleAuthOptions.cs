...
public class GoogleAuthOptions
{
    ...
    public bool HasValidClientIdShape =>
        ClientId.Trim().EndsWith(".apps.googleusercontent.com", StringComparison.OrdinalIgnoreCase);

    public bool IsConfigured =>
        !string.IsNullOrWhiteSpace(ClientId) && !string.IsNullOrWhiteSpace(ClientSecret) && HasValidClientIdShape;
}
